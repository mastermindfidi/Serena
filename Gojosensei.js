...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c15f725add0381fb69c4b.jpg' }, caption: `*Hi Bro ${m.pushName}*\nDonate me on paytm - 918601600591 upi id - 9536476115@paytm,DONATE NOW AND DON'T FORGET TO SUBSCRIBE MY CHANNEL 😁 LINK - https://youtube.com/channel/UCLuR4JkvjkqQT8NebAHqW0Q\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/sahilteamx/Serena\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget TO SUBSCRIBE MY CHANNEL ❤️ LINK - https://youtube.com/channel/UCLuR4JkvjkqQT8NebAHqW0Q`)
            }
            break
case 'allmenu': {
  	anu = `
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
Thanks to Me (👨🏻‍💻 𝙎𝙖𝙝𝙞𝙡 👨🏻‍💻)
𝙎𝙖𝙝𝙞𝙡(For helping me to deploy qr in replit and answered my every doubts regard this project)
LOST HACKER ( 45% Credits goes to him ,in this script)
And Again Me (𝙎𝙖𝙝𝙞𝙡 🥵 😈) 🐦 Who Helped Assemble This Sexy Script Don't forget to subscribe youtube channel 😁 https://youtube.com/channel/UCLuR4JkvjkqQT8NebAHqW0Q !!! instagram 👀     instagram.com/_mastermind_ash_ author 👨🏻‍💻          wa.me/+918601600591`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
